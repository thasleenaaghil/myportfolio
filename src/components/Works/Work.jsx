   ...
   <section id='projects'>
      ...
      <Card style={{ width: '16.5rem' }}>
          ...
          <div className='overlay'>
              ...
              <Card.Body>
                <Card.Title style={{color:'white'}}>Restaurant Website</Card.Title>
      ...
      <Card style={{ width: '18rem' }}>
       <div className='overlay'>
          ...
          <Card.Body>
            <Card.Title style={{color:'white'}}>Travel Website</Card.Title>
      ...
      <div className='overlay'>
         <Card.Img variant="top" src="https://image.winudf.com/v2/image/Y29tLm5vcnRoZHJvaWQuc2ltcGxldGltZXdpZGdldF9pY29uXzE1MzIxMDU1NjNfMDY3/icon.png?w=&fakeurl=1" className='images' />
          <Card.Body>
            <Card.Title style={{color:'white'}}>Weather Search</Card.Title>
      ...
      <Card style={{ width: '18rem' }}>
       <div className='overlay'>
          ...
          <Card.Body>
            <Card.Title style={{color:'white'}}>BMI Calculator</Card.Title>
